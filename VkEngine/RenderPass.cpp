...
//VkRenderPass RenderPass::get_ForwardRenderPass()
//{
//	return this->forwardRP;
//}
//
//VkRenderPass RenderPass::get_DoubleSubPass_RenderPass()
//{
//	return this->deferredRP;
//}

VkRenderPass RenderPass::get_SimpleRenderPass()
{
	return this->simpleRP;
}

VkRenderPass RenderPass::get_OffScreenRenderPass()
{
	return this->offscreenRP;
}

RenderPass::~RenderPass()
{
	vkDestroyRenderPass(Device::get(), this->simpleRP, nullptr);
	vkDestroyRenderPass(Device::get(), this->offscreenRP, nullptr);
	//vkDestroyRenderPass(Device::get(), this->forwardRP, nullptr);
}

void RenderPass::createForwardRenderPass()
{
...
void RenderPass::createSimpleRenderPass()
{
	// Attachment description for the whole renderpass
	...
	if (vkCreateRenderPass(Device::get(), &renderPassInfo, nullptr, &simpleRP) != VK_SUCCESS) {
		throw std::runtime_error("failed to create render pass!");
	}
}

void RenderPass::createOffScreenRenderPass()
{
	// Attachment description for the whole renderpass
	std::array<VkAttachmentDescription, 2> attachments = {};
	//Final color attachment
