...
Material::Material(MaterialType material, SwapChain* swapchain, RenderPass* renderPass)
{
	...
	{
	case SAMPLE:
		this->vertexShader = new Shader("Shaders/sample/vert.spv");
		this->fragmentShader = new Shader("Shaders/sample/frag.spv");
		break;
	case PHONG:
		this->vertexShader = new Shader("Shaders/phong_multi_light/vert.spv");
		this->fragmentShader = new Shader("Shaders/phong_multi_light/frag.spv");
		//this->vertexShader = new Shader("Shaders/sample/vert.spv");
		//this->fragmentShader = new Shader("Shaders/sample/frag.spv");
		break;
	default:
...
void Material::createDescriptorSetLayout()
{
	...
	uniformMatLayoutBinding.binding = 1;
	...
	std::array<VkDescriptorSetLayoutBinding, 2> bindings = { samplerLayoutBinding, uniformMatLayoutBinding };
...
void Material::buildPipeline()
{
	...
	VkDescriptorSetLayout setLayout = this->descriptorSetLayout;
